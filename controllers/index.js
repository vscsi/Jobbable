...
exports.postIndex = async (req, res, next) => {
    ...
    let locationQuery = await knex.from('jobs').select('company', 'title', 'created_at', 'company_logo', 'status', 'job_type', 'id', 'location', 'description').where('location', 'ilike', `%${nameLocation}%`);
    ...
    let companyQuery = await knex.from('jobs').select('company', 'title', 'created_at', 'company_logo', 'status', 'job_type', 'id', 'location', 'description').where('company', 'ilike', `%${nameCompany}%`);
    ...
    // console.log(dataQuery.company_logo);
